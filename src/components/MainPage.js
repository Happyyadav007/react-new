    ...
    return(
        <>  
                ...
                <ul className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 border-black">
                   <li><a href="./happy-yadav-resume.pdf"  rel="noopener noreferrer" target="_blank" className="hover:bg-white transition duration-500 hover:scale-75 w-24 h-24 md:w-32 md:h-32 bg-sky-300 text-black  text-xl md:text-xl font-bold flex items-center justify-center rounded-full border-solid border-2 border-black">Resume</a></li>
                   <li><a href="https://github.com/Happyyadav007" target="_blank" className="hover:bg-white transition duration-500 hover:scale-75 w-24 h-24 md:w-32 md:h-32 bg-red-500 text-black text-xl md:text-xl font-bold flex items-center justify-center rounded-full border-solid border-2 border-black">Projects</a></li>
                   <li><a href="./contact" className="hover:bg-white transition duration-500 hover:scale-75 w-24 h-24 md:w-32 md:h-32 bg-yellow-400 text-black text-xl md:text-xl font-bold flex items-center justify-center rounded-full border-solid border-2 border-black">Contact</a></li>
                 </ul>
                 </div>
                </div>
                </div>
